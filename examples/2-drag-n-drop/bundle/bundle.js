...
var mouseUpStream = _rx2['default'].Observable.fromEvent(input, 'mouseup');
var mouseDownStream = _rx2['default'].Observable.fromEvent(input, 'mousedown');
var mouseMoveStream = _rx2['default'].Observable.fromEvent(document, 'mousemove');

var mouseDragStream = mouseDownStream.flatMap(function (md) {
  var startX = md.offsetX,
      startY = md.offsetY;

  return mouseMoveStream.map(function (mm) {
    mm.preventDefault();
    ...
    return {
      ...
      target: mm.target };
  }). // IMPORTANT CHANGE: the element you care about
  takeUntil(mouseUpStream);
});

mouseDragStream.subscribe(function (event) {
